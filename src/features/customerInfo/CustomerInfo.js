                        ...
                        <TableBody>
                            {filteredCustomers.map((customer) => (
                                <TableRow key={customer.customerId}>
                                    ...
                                    <TableCell sx={{ width: '10%' }} align="center" style={{ border: '1px solid #ccc' }}>{customer.totalBookings || 0}</TableCell>
                                    <TableCell sx={{ width: '35%' }} align="center" style={{ border: '1px solid #ccc' }}>{customer.lastBooking || t('noBookings')}</TableCell>

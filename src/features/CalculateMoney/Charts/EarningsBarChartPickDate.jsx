...
const getChartData = (hourlyEarnings) => {
    const arr = Array.isArray(hourlyEarnings?.$values)
        ? hourlyEarnings.$values
        : Array.isArray(hourlyEarnings) ? hourlyEarnings : [];
...
const EarningsBarChartPickDate = ({ hourlyEarnings }) => {
...
export default EarningsBarChartPickDate;